...
if __name__ == '__main__':
    ...
    liquid = simpledialog.askstring(title="none", prompt="enter an liquid")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title="none", prompt="enter an body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title="none", prompt="enter an verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title="none", prompt="enter an place")
